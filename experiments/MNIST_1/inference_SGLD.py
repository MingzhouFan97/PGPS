...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        inf = inference.Inference_SGLD(base_model, model_para, train_x, train_y, num_samples, device=device, self_p0=True)
        models = inf.performe(torch.tensor(1.), path, adj_size=1e-2, adjust_steps=5000, adj_delta=0.01, device=device)
