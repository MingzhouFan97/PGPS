...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        inf = inference.Inference(base_model, model_para, train_x, train_y, num_samples, device=device, self_p0=True)
        models = inf.performe(torch.tensor(1e5), path, adj_size=1e-2, adjust_steps=300, adj_delta=0.1, device=device, final_adj=2000, max_train_iter=100)
