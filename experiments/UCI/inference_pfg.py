...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        inf = inference.Inference_PFG(base_model, model_para, train_x, train_y, num_samples, device=device)
        models = inf.performe(path, adj_size=torch.tensor(1e-1), device=device, max_iter=4000)
