...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        inf = inference.Inference_SGLD(base_model, model_para, train_x, train_y, num_samples, device=device)
        models = inf.performe(torch.tensor(1.), path, adj_size=1e-1, adjust_steps=4000, adj_delta=0.01, device=device)
