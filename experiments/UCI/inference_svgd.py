...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        inf = inference.Inference_SVGD(base_model, model_para, train_x, train_y, num_samples, device=device)
        models = inf.performe(path=path, adj_size=torch.tensor(.1), device=device, max_iter=4000)
