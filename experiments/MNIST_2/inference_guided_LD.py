...
if __name__ == "__main__":
    ...
    for runs in range(5):
        ...
        # path = ppath.ExpTelePathNN
        inf = inference.Inference_guided_LD(base_model, model_para, train_x, train_y, num_samples, device=device, self_p0=True)
        models = inf.performe(torch.tensor(0.1), path, adj_size=1e-2, adjust_steps=200, adj_delta=0.1, device=device,
                              final_adj=500, max_train_iter=1000)
